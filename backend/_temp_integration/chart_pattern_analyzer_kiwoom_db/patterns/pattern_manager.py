...
from patterns.double_patterns import DoubleTopDetector, DoubleBottomDetector
from patterns.hs_patterns import HeadAndShouldersDetector, InverseHeadAndShouldersDetector
import pandas as pd
