...
# API 정보
# 메뉴 위치
# OAuth 인증 > 접근토큰발급 > 접근토큰 발급(au10001)
# API 명
# 접근토큰 발급
# API ID
au10001
...
# API 정보
# 메뉴 위치
# OAuth 인증 > 접근토큰폐기 > 접근토큰폐기(au10002)
# API 명
# 접근토큰폐기
# API ID
au10002
...
# API 정보
# 메뉴 위치
# 국내주식 > 기관/외국인 > 주식외국인종목별매매동향(ka10008)
# API 명
# 주식외국인종목별매매동향
# API ID
ka10008
...
Y
2
05:0.5 10:1.0, 15:1.5, 20:2.0. 25:2.5, 30:3.0
# Body
mrkt_tp
# 시장구분
# String
...
Y
3
000:전체, 001:코스피, 101:코스닥, 201:코스피200
# Body
flu_tp
# 등락구분
# String
...
Y
1
1:순매수잔량순, 2:순매도잔량순, 3:매수비율순, 4:매도비율순
# Body
trde_qty_tp
# 거래량구분
# String
...
Y
1
5:5일, 10:10일, 20:20일, 60:60일, 250:250일
# Body
trde_qty_tp
# 거래량구분
# String
...
Y
1
0:현재가 매물대 진입 포함안함, 1:현재가 매물대 진입포함
# Body
prpscnt
# 매물대수
# String
...
Y
1
1:저PBR, 2:고PBR, 3:저PER, 4:고PER, 5:저ROE, 6:고ROE
# Body
stex_tp
# 거래소구분
# String
...
Y
1
1:전일거래량 상위100종목, 2:전일거래대금 상위100종목
# Body
rank_strt
# 순위시작
# String
...
Y
2
0:당일, 1:전일, 5:5일, 10;10일, 20:20일, 60:60일
# Body
stex_tp
# 거래소구분
# String
...
Y
2
1:전일, 4:5일, 9:10일, 19:20일, 39:40일, 59:60일, 119:120일
# Response
구분
# Element
한글명
...
N
4
5:5일, 10:10일, 20:20일, 40:40일, 60:60일, 120:120일
# Body
sort_base
# 정렬기준
# String
...
# API 정보
# 메뉴 위치
# 국내주식 > 종목정보 > 변동성완화장치발동종목요청(ka10054)
# API 명
# 변동성완화장치발동종목요청
# API ID
ka10054
...
Y
1
0:전체, 1:정적VI, 2:동적VI, 3:동적VI + 정적VI
# Body
skip_stk
# 제외종목
# String
...
Y
12
100000000 주 이하, 거래량구분이 1일때만 입력(공백허용)
# Body
trde_prica_tp
# 거래대금구분
# String
...
# API 정보
# 메뉴 위치
# 국내주식 > 종목정보 > 투자자별일별매매종목요청(ka10058)
# API 명
# 투자자별일별매매종목요청
# API ID
ka10058
...
# API 정보
# 메뉴 위치
# 국내주식 > 종목정보 > 종목별투자자기관별합계요청(ka10061)
# API 명
# 종목별투자자기관별합계요청
# API ID
ka10061
...
# API 정보
# 메뉴 위치
# 국내주식 > 순위정보 > 장중투자자별매매상위요청(ka10065)
# API 명
# 장중투자자별매매상위요청
# API ID
ka10065
...
# API 정보
# 메뉴 위치
# 국내주식 > 대차거래 > 대차거래상위10종목요청(ka10069)
# API 명
# 대차거래상위10종목요청
# API ID
ka10069
...
# API 정보
# 메뉴 위치
# 국내주식 > 계좌 > 일자별종목별실현손익요청_일자(ka10072)
# API 명
# 일자별종목별실현손익요청_일자
# API ID
ka10072
...
# API 정보
# 메뉴 위치
# 국내주식 > 계좌 > 일자별종목별실현손익요청_기간(ka10073)
# API 명
# 일자별종목별실현손익요청_기간
# API ID
ka10073
...
# API 정보
# 메뉴 위치
# 국내주식 > 순위정보 > 시간외단일가등락율순위요청(ka10098)
# API 명
# 시간외단일가등락율순위요청
# API ID
ka10098
...
500:5천주이상, 1000:만주이상, 5000:5만주이상,
10000:10만주이상
# Body
crd_cnd
# 신용조건
...
1
0:전체조회, 9:신용융자전체, 1:신용융자A군, 2:신용융자B군,
3:신용융자C군, 4:신용융자D군, 7:신용융자E군, 8:신용대주,
5:신용한도초과제외
# Body
trde_prica
# 거래대금
...
# API 정보
# 메뉴 위치
# 국내주식 > 기관/외국인 > 기관외국인연속매매현황요청(ka10131)
# API 명
# 기관외국인연속매매현황요청
# API ID
ka10131
...
N
8
# YYYYMMDD(공백입력시 금일데이터,최근 2개월까지 제공)
# Body
ottks_tp
# 단주구분
# String
...
# String
N
# 연속 데이터가 존재하는경우 Y, 없으면 N
# Body
next_key
# 연속조회키
# String
N
# 연속조회여부가Y일경우 다음 조회시 필요한 조회값
244 / 526
...
101:종합(KOSDAQ), 201:KOSPI200, 302:KOSTAR, 701:
# KRX100 나머지 ※ 업종코드 참고
# Response
구분
# Element
...
# API 정보
# 메뉴 위치
# 국내주식 > 대차거래 > 대차거래추이요청(종목별)(ka20068)
# API 명
# 대차거래추이요청(종목별)
# API ID
ka20068
...
# API 정보
# 메뉴 위치
# 국내주식 > ELW > 거래원별ELW순매매상위요청(ka30002)
# API 명
# 거래원별ELW순매매상위요청
# API ID
ka30002
...
Y
2
1:전일, 5:5일, 10:10일, 40:40일, 60:60일
# Body
trde_end_elwskip
# 거래종료ELW제외
# String
...
# API 정보
# 메뉴 위치
# 국내주식 > ELW > ELWLP보유일별추이요청(ka30003)
# API 명
# ELWLP보유일별추이요청
# API ID
ka30003
...
# 미래대우:000,,,5, 신영:000,,,6, NK투자증권:000,,,12,
# KB증권:000,,,17)
# Body
bsis_aset_cd
# 기초자산코드
...
# 한국투자증권:003, 미래대우:005, 신영:006, NK투자증권:012,
# KB증권:017)
# Body
sort_tp
# 정렬구분
...
3191:TIGER(미래에셋), 3228:KINDEX(한국투자),
...
Y
20
M04020000 금 99.99_1kg, M04020100 미니금 99.99_100g
# Response
구분
# Element
한글명
...
# API 정보
# 메뉴 위치
# 국내주식 > 종목정보 > 프로그램순매수상위50요청(ka90003)
# API 명
# 프로그램순매수상위50요청
# API ID
ka90003
...
# API 정보
# 메뉴 위치
# 국내주식 > 종목정보 > 종목별프로그램매매현황요청(ka90004)
# API 명
# 종목별프로그램매매현황요청
# API ID
ka90004
...
# API 정보
# 메뉴 위치
# 국내주식 > 시세 > 프로그램매매추이요청 시간대별(ka90005)
# API 명
# 프로그램매매추이요청 시간대별
# API ID
ka90005
...
# API 정보
# 메뉴 위치
# 국내주식 > 시세 > 프로그램매매차익잔고추이요청(ka90006)
# API 명
# 프로그램매매차익잔고추이요청
# API ID
ka90006
...
# API 정보
# 메뉴 위치
# 국내주식 > 시세 > 종목시간별프로그램매매추이요청(ka90008)
# API 명
# 종목시간별프로그램매매추이요청
# API ID
ka90008
...
# API 정보
# 메뉴 위치
# 국내주식 > 시세 > 프로그램매매추이요청 일자별(ka90010)
# API 명
# 프로그램매매추이요청 일자별
# API ID
ka90010
...
# API 정보
# 메뉴 위치
# 국내주식 > 시세 > 종목일별프로그램매매추이요청(ka90013)
# API 명
# 종목일별프로그램매매추이요청
# API ID
ka90013
...
Y
1
0:전체, 1:코스피, 2:코스닥, 3:OTCBB, 4:ECN
# Body
sell_tp
# 매도수구분
# String
...
# API 정보
# 메뉴 위치
# 국내주식 > 계좌 > 증거금율별주문가능수량조회요청(kt00011)
# API 명
# 증거금율별주문가능수량조회요청
# API ID
kt00011
...
# API 정보
# 메뉴 위치
# 국내주식 > 계좌 > 신용보증금율별주문가능수량조회요청(kt00012)
# API 명
# 신용보증금율별주문가능수량조회요청
# API ID
kt00012
...
Y
1
0:전체, 1:국내주식, 2:수익증권, 3:해외주식, 4:금융상품
# Body
frgn_stex_code
# 해외거래소코드
# String
...
12
# Body
crd_int_npay_gold_fr
# 신용이자미납금_초
# String
N
12
# Body
crd_int_npay_gold_to
# 신용이자미납금_말
# String
N
12
...
N
1
0:전체, 1:입출금, 2:출고, 3:매매, 4:매수, 5:매도, 6:입금, 7:출금
# Body
stk_cd
# 종목코드
# String
...
# String
N
# 등록,해지요청시 요청값 반환 , 실시간수신시 REAL 반환
# Body
data
# 실시간 등록리스트
# LIST
...
1
1501
# API ID가 Null이거나 값이 없습니다
2
1504
해당 URI에서는 지원하는 API ID가 아닙니다. API ID={?}, URI={?}
3
1505
해당 API ID는 존재하지 않습니다. API ID={?}
4
1511
...
12
1700
허용된 요청 개수를 초과하였습니다. API ID={?}
13
1901
시장 코드값이 존재하지 않습니다. 종목코드={?}
14
1902
종목 정보가 없습니다. 입력한 종목코드 값을 확인바랍니다. 종목코드={?}
15
1999
예기치 못한 에러가 발생했습니다. 실패사유={?}
16
8001
# App Key와 Secret Key 검증에 실패했습니다
17
8002
